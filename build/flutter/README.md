...
* `ssc_tsiakhe_chat` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `ssc-tsiakhe-chat` - executable or bundle name on disk.
* `ssc-tsiakhe-chat` - display name shown in window titles and about app dialogs.
